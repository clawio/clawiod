...
func New(conf *config.Config) (*Server, error) {
	...
	log := capnslog.NewPackageLogger("github.com/clawio/clawiod", "src/server")
	s := &Server{log: log, srv: srv, conf: conf}
...
func (s *Server) handler() http.Handler {
	handlerFunc := func(w http.ResponseWriter, r *http.Request) {
		...
		cLog = capnslog.NewPackageLogger("github.com/clawio/clawiod", "trace-"+tid)
